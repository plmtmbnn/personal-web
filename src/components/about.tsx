    ...
    <div className="text-center max-w-2xl w-full space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Fade delay={500}>
          <Slide direction="up" duration={1200}>
            <div className="p-6 bg-white text-gray-900 rounded-lg shadow-lg">
              <h3 className="text-lg font-bold text-gray-700">Professional Role</h3>
              ...
              <div className="flex justify-center gap-6 mt-4">
                ...
                <FaDocker size={25} className="text-teal-500" title="MongoDB" />
        ...
        <Fade delay={700}>
          <Slide direction="up" duration={1200}>
            <div className="p-6 bg-white text-gray-900 rounded-lg shadow-lg">
              <h3 className="text-lg font-bold text-gray-700">Hobbies and Interests</h3>
              <p className="text-base text-gray-700">
                Outside of coding, I run trails, capture landscapes through photography, and enjoy exploring new places.
              </p>
              <div className="flex justify-center gap-6 mt-4">
                <FaRunning size={25} className="text-gray-400" title="Running" />
                <FaFutbol size={25} className="text-gray-400" title="Football" />
                <FaCameraRetro size={25} className="text-gray-400" title="Camera" />
                <MdOutlineModeOfTravel size={25} className="text-gray-400" title="Travel" />
              </div>
            </div>
          </Slide>
        </Fade>
