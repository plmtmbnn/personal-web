		...
		<div className="max-w-7xl w-full text-center space-y-12 lg:space-y-16 relative z-10">
			...
			<div className="space-y-6">
				<JackInTheBox delay={200} triggerOnce>
					...
					<h2 className="text-5xl sm:text-6xl lg:text-2xl font-bold bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent tracking-tight">
						Adventures
					</h2>
					...
					(
						...
						<Zoom delay={200 * index} duration={1000} triggerOnce key={title}>
							<div className="group relative h-full">
								...
								<div
									className={`absolute -inset-1 bg-gradient-to-r ${gradient} opacity-20 rounded-3xl blur group-hover:opacity-40 transition duration-1000`}
								></div>
								...
								<div className="relative h-full bg-gray-800/60 backdrop-blur-md rounded-3xl border border-gray-700/50 hover:border-gray-600 transition-all duration-300 overflow-hidden">
									...
									<div className="p-6 lg:p-8 border-b border-gray-700/50">
										<div className="flex items-start justify-between mb-4">
											{/* Icon */}
											<div
												className={`p-4 bg-gradient-to-br ${gradient} rounded-xl shadow-lg`}
											>
											...
											{/* Platform Badge */}
											<div
												className={`${badgeColor} p-2 rounded-lg text-white shadow-lg`}
											>
												{badge}
											</div>
										</div>
										...
										<div className="text-left">
											...
											<div
												className={`w-16 h-1 bg-gradient-to-r ${gradient} rounded-full mb-4`}
											></div>
									...
									<div className="px-6 lg:px-8 pb-6 lg:pb-8">
										<div
											className={
												"flex items-center gap-2 text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-300"
											}
										>
											<div
												className={`w-2 h-2 bg-gradient-to-r ${gradient} rounded-full animate-pulse`}
											></div>
