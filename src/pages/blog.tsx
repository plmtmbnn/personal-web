...
import { HiArrowRight, HiClock, HiNewspaper, HiSparkles } from "react-icons/hi";
...
const Blog = () => (
	<>
		<Helmet>
			...
			<meta
				name="description"
				content="Explore my thoughts, writings, and experiences. Stay tuned for updates!"
			/>
			<meta
				name="keywords"
				content="Polma Tambunan, blog, software engineer, writing, experiences, technology, running"
			/>
			...
			<div className="max-w-6xl w-full text-center space-y-12 lg:space-y-16 relative z-10">
				...
				<div className="space-y-6">
					<JackInTheBox delay={150} triggerOnce>
						...
						<h2 className="text-5xl sm:text-6xl lg:text-2xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent tracking-tight">
							Blog
						</h2>
						...
						<div className="relative group max-w-2xl mx-auto">
							...
							<div className="relative p-12 bg-gray-800/60 backdrop-blur-md rounded-2xl border border-gray-700/50">
								...
								<p className="text-gray-300 text-lg leading-relaxed">
									No blog posts yet — but exciting content is on the way! Check
									back soon for insights on software engineering, fintech, and
									more.
								</p>
