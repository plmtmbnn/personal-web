...
const ToggleIndicator: React.FC<ToggleIndicatorProps> = ({
	isCollapsed,
	onClick,
}) => (
	<div
		className="ml-auto text-sm cursor-pointer text-gray-400 hover:text-white transition-colors duration-300"
		onClick={onClick}
	>
		{isCollapsed ? (
			...
			<div className="max-w-7xl w-full text-center space-y-12 lg:space-y-16 relative z-10">
				...
				<div className="space-y-6">
					<JackInTheBox delay={200} triggerOnce>
						...
						<h2 className="text-2xl sm:text-4xl lg:text-2xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent tracking-tight">
							Portfolio
						</h2>
					</JackInTheBox>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
					...
					<div className="space-y-6 lg:space-y-8">
						...
						<Fade triggerOnce>
							<div
								className={`relative group transition-all duration-500 ${!isCollapsedLOS || activeSlice === 0 ? "ring-2 ring-blue-500/50" : ""}`}
							>
								...
								<div className="relative bg-gray-800/60 backdrop-blur-md rounded-2xl border border-gray-700/50 hover:border-gray-600 transition-all duration-300 p-6 lg:p-8">
									...
									>
										...
										<p className="text-gray-300 text-base leading-relaxed mb-6 text-left">
											Developed comprehensive end-to-end LOS & LMS systems for
											multiple fintech companies, handling millions in loan
											transactions.
										</p>
												...
												{[
													{
														...
														desc: "Seamless registration and verification process",
													},
													{
														icon: "🔍",
														title: "eKYC System",
														desc: "Automated digital identity verification",
													},
													{
														icon: "📊",
														title: "Underwriting Workflow",
														desc: "Intelligent risk assessment engine",
													},
													{
														icon: "✍️",
														title: "Digital Signing",
														desc: "Secure and compliant document authentication",
													},
													{
														icon: "💸",
														title: "Disbursement Engine",
														desc: "Instant and automated loan processing",
													},
													{
														icon: "📥",
														title: "Collection Module",
														desc: "Smart recovery and repayment tracking",
													},
													{
														icon: "📚",
														title: "Accounting & Reports",
														desc: "Tools for compliance, audit, and insights",
													},
												].map((item, index) => (
													<div
														key={index}
													...
													>
														<p className="font-semibold text-white mb-2 flex items-center gap-2">
															...
															<span className="group-hover/card:text-blue-400 transition-colors duration-300">
																{item.title}
															</span>
														</p>
						...
						<Fade triggerOnce>
							<div
								className={`relative group transition-all duration-500 ${!isCollapsedOther || activeSlice === 1 ? "ring-2 ring-purple-500/50" : ""}`}
							>
												...
												{[
													{
														...
														desc: "Manage products, policies, and underwriting in one platform",
														color: "from-blue-500 to-cyan-500",
													},
													{
														icon: "🧰",
														title: "Standalone Tools",
														desc: "KTP OCR for automated ID extraction and Bank Statement Extractor for financial data analysis",
														color: "from-emerald-500 to-teal-500",
													},
													{
														icon: "🏛️",
														title: "Organization App",
														desc: "Handle member onboarding, digital identity cards, and cadre tracking efficiently",
														color: "from-orange-500 to-red-500",
													},
													{
														icon: "📈",
														title: "Investment App",
														desc: "Stay updated with live news, market trends, and portfolio insights",
													...
													>
														<div
															className={`absolute inset-0 bg-gradient-to-r ${item.color} opacity-0 group-hover/card:opacity-10 transition-opacity duration-300`}
														></div>
														<div className="relative p-5 bg-gray-700/30 rounded-xl border border-gray-600/30 hover:border-purple-500/50 transition-all duration-300">
															<h4 className="font-semibold text-white mb-2 flex items-center gap-2 text-lg">
																...
																<span className="group-hover/card:text-purple-400 transition-colors duration-300">
																	{item.title}
																</span>
															</h4>
