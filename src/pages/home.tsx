      ...
      <div className="lg:col-span-4 xl:col-span-2 space-y-6 sm:space-y-8 lg:space-y-10 text-left lg:text-left xl:text-left">
        <Fade delay={150} triggerOnce>
          <div className="space-y-4 lg:space-y-6">
            ...
            <h1 className="text-2xl sm:text-4xl lg:text-6xl xl:text-5xl 2xl:text-4xl font-bold text-white leading-tight">
              🌏, I'm{' '}
        ...
        <Fade delay={350} triggerOnce>
          <p className="text-lg sm:text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl text-gray-300 max-w-4xl leading-relaxed">
            For the past <span className="text-blue-400 font-semibold">{experienceYears}+ years</span>, I've been building 
            secure, scalable, and impactful software—primarily in the{' '}
            <span className="text-purple-400 font-semibold">fintech space</span>. From lending platforms to digital identity systems, 
            I bring engineering focus to critical business needs.
          </p>
        </Fade>
              ...
              <div className="relative flex items-center gap-4 lg:gap-6 p-6 lg:p-8 bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-700/50 hover:border-gray-600 transition-all duration-300">
                ...
                <div>
                  <p className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white">
                    <CountdownNumber to={experienceYears} duration={1000} />+ Years
                  </p>
                  <p className="text-gray-400 text-sm lg:text-base">Software Development</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden">
              ...
              <div className="relative flex items-center gap-4 lg:gap-6 p-6 lg:p-8 bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-700/50 hover:border-gray-600 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm lg:text-base">Running per year</p>
                </div>
              </div>
            </div>
          </div>
